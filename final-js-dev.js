	...
	------------------------------------------------------- */
	    ...
	    function modalQuery(empty){
	        ...
	        if(fixedSidebar){
	            ...
	            modalQueryString = '@media all and (min-width: ' + (projectWidth+100) + 'px) { .swiper-container { width: ' + sliderWidth + 'px !important; height:' + sliderHeight + 'px !important; } } @media all and (max-height:' + (sliderHeight+100) + 'px) and (min-width: ' + (projectWidth+100) + 'px) { #portfolio-detail { position: relative !important; padding: 50px 0 !important; } .project-modal { top: 0 !important; margin-top: 0 !important; margin-left: ' + (-projectWidth/2) + 'px !important; } } @media all and (max-width: ' + (projectWidth+100) + 'px) and (min-width: ' + (sliderWidth+100) + 'px) { .swiper-container { width: ' + sliderWidth + 'px !important; height: ' + sliderHeight + 'px !important; } } @media all and (max-width: ' + (projectWidth+100) + 'px) { #portfolio-detail { position: relative !important; padding: 50px 0; } .project-modal { height: auto !important; width: ' + sliderWidth + 'px !important; margin-left: -' + (sliderWidth/2) + 'px !important; margin-top: 0 !important; top: 0 !important; } .project-modal .content { padding-right: 0 !important; padding-bottom:30px !important; width: 100% !important; height: auto; overflow: visible; float: left; top: -15px; } .project-modal .nav { position: relative; float: right; top: 45px; left: auto; right: 30px; } .project-modal h1 { width:80%; } } @media all and (max-width: ' + (sliderWidth+100) + 'px) { #portfolio-detail { padding:0; } .project-modal { width: 100% !important; margin-left: 0 !important; left: 0 !important; float: left; } .modal.single { width: 100% !important; height: auto !important; } .modal.swiper-container { width: 100% !important; } .modal.swiper-container img, .modal.single img { width: 100% !important; height: auto !important; top: 0 !important; left: 0 !important; } #modal-test-query { display: block; } }';
...
// This function closes the projects window
	    ...
	    function closeProject(e) {
	        ...
	        $project.stop().fadeOut(400, function(){
	           ...
	           $(window).scrollTop($folioContainer.css('top')).css('top',0);
	                $('#portfolio').css('top',0);
	...
	//    }  aca cerraba la funcion, pero ahora para agregar la animacion, agregamos:
		...
		// here closes the closing function

			

			  /*  Comienza la function closes the projects ands animate 
	         *  ////////////////////////////////////////////////////////////////////////////
	         * ////////////////////////////////////////////////////////////////////////////
	         * ////////////////////////////////////////////////////////////////////////////
	         * ////////////////////////////////////////////////////////////////////////////
		...
		$('html').animate({scrollTop:$portNegativeinterno}, 500, 'easeOutQuad');	
		 ...
		 /*  End function closes the projects ands animate 
	         *  ////////////////////////////////////////////////////////////////////////////
	         * ////////////////////////////////////////////////////////////////////////////
	         * ////////////////////////////////////////////////////////////////////////////
	         * ////////////////////////////////////////////////////////////////////////////
	    ...
	    if($body.hasClass('single') && $body.hasClass('is-portfolio')) {
	        ...
	        initFolioScripts(function(){
	            ...
	            if(!$body.hasClass('sidebar-show')) {
            		...
            		if ( ! $('body').hasClass('s-opened-portfolio') ) {
             	 		$sidebar.delay(300).animate({'left': -260}, 200);
             	 		eventTimeout = 500;
            		}
	    ...
	    function initDefShortcodes(){
	      ...
	      //  console.log('shortcodes');
	        $('.krown-accordion').each(function(){
	            ...
	            console.log('what?! tiggle')

	            $(this).children('section').children('h5').click(function(){

	                var $this = $(this).parent();
	                console.log($this, toggle, $opened)
	...
	------------------------------------------------------- */
	    ...
	    function check3D(){
	        ...
	        if($html.hasClass('no-csstransforms') || $projectHolder.hasClass('no-3deffects') || $html.hasClass('ie10')) {
	            ...
	            $folioItems.on('mouseover', function(){
	            ...
	            $folioItems.on('mouseover', function(){
	                ...
	                if(!$(this).hasClass('isotope-hidden')) {
	                	...
	                	TweenMax.to($(this).find('.folio-cube'), .3, {
	                		rotationX: 90,
	                		translateZ: Math.ceil(-$(this).height()/2),
	                		opacity: 1,
	                		overwrite: 'all',
	                		ease: Quad.easeInOut
	                	})
